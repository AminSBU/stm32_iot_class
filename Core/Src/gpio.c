...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED_DB1_Pin|LED_DB2_Pin|LED_DB3_Pin|LED_DB4_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_DB5_GPIO_Port, LED_DB5_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, EEPR_WP_Pin|Relay_Out_7_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MCP2515_CS_Pin|Out_Cmd3_Pin|Out_Cmd4_Pin|GPIO_PIN_8
                          |Out_Cmd5_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_9|Relay_Out_14_Pin|Relay_Out_13_Pin|Relay_Out_12_Pin
